...
public enum WidgetType {
	...
	EV_BMS_RANGE_WINDOW("ev_bms_range_window", R.string.ev_bms_widget_range_window, R.string.ev_bms_widget_range_window_desc, R.drawable.widget_obd_speed_day, R.drawable.widget_obd_speed_night, 0, EV_BMS, RIGHT),
	EV_BMS_RANGE_PNZ("ev_bms_range_pnz", R.string.ev_bms_widget_range_pnz, R.string.ev_bms_widget_range_pnz_desc, R.drawable.widget_obd_speed_day, R.drawable.widget_obd_speed_night, 0, EV_BMS, RIGHT),
	...
	EV_CHARGE_TIME("ev_charge_time", R.string.ev_bms_widget_charge_time, R.string.ev_bms_widget_charge_time_desc, R.drawable.widget_intermediate_time_day, R.drawable.widget_intermediate_time_night, 0, EV_BMS, RIGHT),
	EV_CHARGE_ENERGY("ev_charge_energy", R.string.ev_bms_widget_charge_energy, R.string.ev_bms_widget_charge_energy_desc, R.drawable.widget_obd_fuel_consumption_day, R.drawable.widget_obd_fuel_consumption_night, 0, EV_BMS, RIGHT),
	...
	EV_BMS_TIME("ev_bms_time", R.string.ev_bms_field_time, R.string.ev_bms_field_time, R.drawable.widget_intermediate_time_day, R.drawable.widget_intermediate_time_night, 0, EV_BMS, RIGHT),
	EV_BMS_LAT("ev_bms_lat", R.string.ev_bms_field_lat, R.string.ev_bms_field_lat, R.drawable.widget_marker_day, R.drawable.widget_marker_night, 0, EV_BMS, RIGHT),
	EV_BMS_LON("ev_bms_lon", R.string.ev_bms_field_lon, R.string.ev_bms_field_lon, R.drawable.widget_marker_day, R.drawable.widget_marker_night, 0, EV_BMS, RIGHT),
	EV_BMS_GPS_SPEED("ev_bms_gps_speed", R.string.ev_bms_field_gps_speed, R.string.ev_bms_field_gps_speed, R.drawable.widget_obd_speed_day, R.drawable.widget_obd_speed_night, 0, EV_BMS, RIGHT),
	EV_BMS_SOC_OCV("ev_bms_soc_ocv", R.string.ev_bms_field_soc_ocv, R.string.ev_bms_field_soc_ocv, R.drawable.widget_obd_fuel_remaining_day, R.drawable.widget_obd_fuel_remaining_night, 0, EV_BMS, RIGHT),
	EV_BMS_REMAINING_AH("ev_bms_remaining_ah", R.string.ev_bms_field_remaining_ah, R.string.ev_bms_field_remaining_ah, R.drawable.widget_obd_fuel_remaining_day, R.drawable.widget_obd_fuel_remaining_night, 0, EV_BMS, RIGHT),
	EV_BMS_FULL_AH("ev_bms_full_ah", R.string.ev_bms_field_full_ah, R.string.ev_bms_field_full_ah, R.drawable.widget_obd_fuel_remaining_day, R.drawable.widget_obd_fuel_remaining_night, 0, EV_BMS, RIGHT),
	EV_BMS_CYCLES("ev_bms_cycles", R.string.ev_bms_field_cycles, R.string.ev_bms_field_cycles, R.drawable.widget_trip_recording_day, R.drawable.widget_trip_recording_night, 0, EV_BMS, RIGHT),
	EV_BMS_MAX_CELL("ev_bms_max_cell", R.string.ev_bms_field_max_cell, R.string.ev_bms_field_max_cell, R.drawable.widget_obd_battery_voltage_day, R.drawable.widget_obd_battery_voltage_night, 0, EV_BMS, RIGHT),
	EV_BMS_IMBALANCE("ev_bms_imbalance", R.string.ev_bms_field_cell_imbalance, R.string.ev_bms_field_cell_imbalance, R.drawable.widget_obd_battery_voltage_day, R.drawable.widget_obd_battery_voltage_night, 0, EV_BMS, RIGHT),
	EV_BMS_CTRL_VOLTAGE("ev_bms_ctrl_voltage", R.string.ev_bms_field_ctrl_voltage, R.string.ev_bms_field_ctrl_voltage, R.drawable.widget_obd_battery_voltage_day, R.drawable.widget_obd_battery_voltage_night, 0, EV_BMS, RIGHT),
	EV_BMS_CTRL_CURRENT("ev_bms_ctrl_current", R.string.ev_bms_field_ctrl_current, R.string.ev_bms_field_ctrl_current, R.drawable.widget_obd_engine_calculated_load_day, R.drawable.widget_obd_engine_calculated_load_night, 0, EV_BMS, RIGHT),
	EV_BMS_RPM("ev_bms_rpm", R.string.ev_bms_field_rpm, R.string.ev_bms_field_rpm, R.drawable.widget_obd_engine_calculated_load_day, R.drawable.widget_obd_engine_calculated_load_night, 0, EV_BMS, RIGHT),
	EV_BMS_GEAR("ev_bms_gear", R.string.ev_bms_field_gear, R.string.ev_bms_field_gear, R.drawable.widget_obd_vehicle_info_day, R.drawable.widget_obd_vehicle_info_night, 0, EV_BMS, RIGHT),
	EV_BMS_ODOMETER("ev_bms_odometer", R.string.ev_bms_field_odometer, R.string.ev_bms_field_odometer, R.drawable.widget_trip_recording_day, R.drawable.widget_trip_recording_night, 0, EV_BMS, RIGHT),
	EV_BMS_CTRL_SPEED("ev_bms_ctrl_speed", R.string.ev_bms_field_ctrl_speed, R.string.ev_bms_field_ctrl_speed, R.drawable.widget_obd_speed_day, R.drawable.widget_obd_speed_night, 0, EV_BMS, RIGHT),
	EV_BMS_WHEEL_SPEED("ev_bms_wheel_speed", R.string.ev_bms_field_wheel_speed, R.string.ev_bms_field_wheel_speed, R.drawable.widget_sensor_speed_day, R.drawable.widget_sensor_speed_night, 0, EV_BMS, RIGHT),
	EV_BMS_WHEEL_ODO("ev_bms_wheel_odo", R.string.ev_bms_field_wheel_odometer, R.string.ev_bms_field_wheel_odometer, R.drawable.widget_sensor_distance_day, R.drawable.widget_sensor_distance_night, 0, EV_BMS, RIGHT),
	EV_BMS_CADENCE("ev_bms_cadence", R.string.ev_bms_field_cadence, R.string.ev_bms_field_cadence, R.drawable.widget_sensor_cadence_day, R.drawable.widget_sensor_cadence_night, 0, EV_BMS, RIGHT),
	EV_BMS_USED_AH("ev_bms_used_ah", R.string.ev_bms_field_used_ah, R.string.ev_bms_field_used_ah, R.drawable.widget_obd_fuel_remaining_day, R.drawable.widget_obd_fuel_remaining_night, 0, EV_BMS, RIGHT),
	EV_BMS_COVERAGE("ev_bms_coverage", R.string.ev_bms_field_coverage, R.string.ev_bms_field_coverage, R.drawable.widget_obd_fuel_consumption_day, R.drawable.widget_obd_fuel_consumption_night, 0, EV_BMS, RIGHT),
	EV_BMS_STOP_TIME("ev_bms_stop_time", R.string.ev_bms_field_stop_time, R.string.ev_bms_field_stop_time, R.drawable.widget_intermediate_time_day, R.drawable.widget_intermediate_time_night, 0, EV_BMS, RIGHT),
